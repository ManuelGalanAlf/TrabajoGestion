DROP TABLE IF EXISTS tPermiso CASCADE;
DROP TABLE IF EXISTS tUsuario CASCADE;
DROP TABLE IF EXISTS tPiezas CASCADE;
DROP TABLE IF EXISTS tTipoPieza CASCADE;
DROP TABLE IF EXISTS tRol CASCADE;
